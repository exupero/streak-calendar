...
return cljs.core.map.call(null,(function (p1__18450_SHARP_){
if(typeof p1__18450_SHARP_ === 'number'){
return (x * p1__18450_SHARP_);
} else {
return p1__18450_SHARP_;
}
}),ps);
});
...
var map__18466__$1 = ((cljs.core.seq_QMARK_.call(null,map__18466))?cljs.core.apply.call(null,cljs.core.hash_map,map__18466):map__18466);
var year = cljs.core.get.call(null,map__18466__$1,new cljs.core.Keyword(null,"year","year",335913393));
var width = (147);
...
var size = (18);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transform","transform",1381301764),"translate(1,14)"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4936__auto__ = ((function (start,stop,size,width,map__18466,map__18466__$1,year){
return (function streak$core$ui_$_iter__18467(s__18468){
return (new cljs.core.LazySeq(null,((function (start,stop,size,width,map__18466,map__18466__$1,year){
return (function (){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__18470),streak$core$ui_$_iter__18467.call(null,cljs.core.chunk_rest.call(null,s__18468__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__18470),null);
}
} else {
var m = cljs.core.first.call(null,s__18468__$2);
var d = (new Date(year,m,(1)));
var offset = (((parseInt(streak.core.day.call(null,d)) === (0)))?cljs.core.identity:cljs.core.inc);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"transform","transform",1381301764),[cljs.core.str("translate(0,"),cljs.core.str((offset.call(null,parseInt(streak.core.week.call(null,d))) * size)),cljs.core.str(") rotate(-90)")].join(''),new cljs.core.Keyword(null,"dy","dy",1719547243),(12),new cljs.core.Keyword(null,"text-anchor","text-anchor",585613696),"end"], null),streak.core.month.call(null,d)], null),streak$core$ui_$_iter__18467.call(null,cljs.core.rest.call(null,s__18468__$2)));
}
} else {
return null;
}
...
});})(start,stop,size,width,map__18466,map__18466__$1,year))
,null,null));
});})(start,stop,size,width,map__18466,map__18466__$1,year))
;
return iter__4936__auto__.call(null,cljs.core.range.call(null,(12)));
})()], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transform","transform",1381301764),"translate(17,0)"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"x","x",2099068185),(((7) * size) / (2)),new cljs.core.Keyword(null,"dy","dy",1719547243),(-2),new cljs.core.Keyword(null,"text-anchor","text-anchor",585613696),"middle"], null),year], null),(function (){var iter__4936__auto__ = ((function (start,stop,size,width,map__18466,map__18466__$1,year){
return (function streak$core$ui_$_iter__18471(s__18472){
return (new cljs.core.LazySeq(null,((function (start,stop,size,width,map__18466,map__18466__$1,year){
return (function (){
var s__18472__$1 = s__18472;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__18472__$1);
if(temp__4126__auto__){
var s__18472__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__18472__$2)){
var c__4934__auto__ = cljs.core.chunk_first.call(null,s__18472__$2);
var size__4935__auto__ = cljs.core.count.call(null,c__4934__auto__);
var b__18474 = cljs.core.chunk_buffer.call(null,size__4935__auto__);
if((function (){var i__18473 = (0);
while(true){
if((i__18473 < size__4935__auto__)){
var d = cljs.core._nth.call(null,c__4934__auto__,i__18473);
cljs.core.chunk_append.call(null,b__18474,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"rect","rect",-108902628),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"class","class",-2030961996),"day",new cljs.core.Keyword(null,"x","x",2099068185),(size * streak.core.day.call(null,d)),new cljs.core.Keyword(null,"y","y",-1757859776),(size * streak.core.week.call(null,d)),new cljs.core.Keyword(null,"width","width",-384071477),size,new cljs.core.Keyword(null,"height","height",1025178622),size], null)], null));

var G__18480 = (i__18473 + (1));
i__18473 = G__18480;
continue;
} else {
return true;
...
})(),(function (){var iter__4936__auto__ = ((function (start,stop,size,width,map__18466,map__18466__$1,year){
return (function streak$core$ui_$_iter__18475(s__18476){
return (new cljs.core.LazySeq(null,((function (start,stop,size,width,map__18466,map__18466__$1,year){
return (function (){
var s__18476__$1 = s__18476;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__18476__$1);
if(temp__4126__auto__){
var s__18476__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__18476__$2)){
var c__4934__auto__ = cljs.core.chunk_first.call(null,s__18476__$2);
var size__4935__auto__ = cljs.core.count.call(null,c__4934__auto__);
var b__18478 = cljs.core.chunk_buffer.call(null,size__4935__auto__);
if((function (){var i__18477 = (0);
while(true){
if((i__18477 < size__4935__auto__)){
var m = cljs.core._nth.call(null,c__4934__auto__,i__18477);
cljs.core.chunk_append.call(null,b__18478,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"month",new cljs.core.Keyword(null,"d","d",1972142424),streak.core.path.call(null,streak.core.scale.call(null,streak.core.month_path.call(null,m),size))], null)], null));

var G__18481 = (i__18477 + (1));
i__18477 = G__18481;
continue;
} else {
return true;
...
var e__10199__auto____$1 = e18489;
...
var e__10199__auto____$2 = e18490;
...
}catch (e18491){if((e18491 instanceof Error)){
var e__10199__auto____$3 = e18491;
...
var c__6473__auto___18515 = cljs.core.async.chan.call(null,(1));
cljs.core.async.impl.dispatch.run.call(null,((function (c__6473__auto___18515){
return (function (){
var f__6474__auto__ = (function (){var switch__6452__auto__ = ((function (c__6473__auto___18515){
return (function (state_18506){
var state_val_18507 = (state_18506[(1)]);
if((state_val_18507 === (1))){
var inst_18492 = cljs.core.async.chan.call(null);
var inst_18493 = [new cljs.core.Keyword(null,"year","year",335913393)];
var inst_18494 = (new Date());
var inst_18495 = inst_18494.getFullYear();
var inst_18496 = [inst_18495];
var inst_18497 = cljs.core.PersistentHashMap.fromArrays(inst_18493,inst_18496);
var inst_18498 = vdom.elm.foldp.call(null,streak.core.step,inst_18497,inst_18492);
var inst_18499 = streak.core.ui.call(null,inst_18492);
var inst_18500 = cljs.core.PersistentVector.EMPTY_NODE;
var inst_18501 = [inst_18498];
var inst_18502 = (new cljs.core.PersistentVector(null,1,(5),inst_18500,inst_18501,null));
var inst_18503 = cljs.core.async.map.call(null,inst_18499,inst_18502);
var inst_18504 = vdom.elm.render_BANG_.call(null,inst_18503,document.body);
var state_18506__$1 = state_18506;
return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_18506__$1,inst_18504);
} else {
return null;
}
});})(c__6473__auto___18515))
;
return ((function (switch__6452__auto__,c__6473__auto___18515){
return (function() {
var streak$core$state_machine__6453__auto__ = null;
var streak$core$state_machine__6453__auto____0 = (function (){
var statearr_18511 = [null,null,null,null,null,null,null];
(statearr_18511[(0)] = streak$core$state_machine__6453__auto__);

(statearr_18511[(1)] = (1));

return statearr_18511;
});
var streak$core$state_machine__6453__auto____1 = (function (state_18506){
while(true){
var ret_value__6454__auto__ = (function (){try{while(true){
var result__6455__auto__ = switch__6452__auto__.call(null,state_18506);
...
var ex__6456__auto__ = e18512;
var statearr_18513_18516 = state_18506;
(statearr_18513_18516[(5)] = ex__6456__auto__);
...
var G__18517 = state_18506;
state_18506 = G__18517;
continue;
} else {
...
streak$core$state_machine__6453__auto__ = function(state_18506){
switch(arguments.length){
case 0:
return streak$core$state_machine__6453__auto____0.call(this);
case 1:
return streak$core$state_machine__6453__auto____1.call(this,state_18506);
}
...
;})(switch__6452__auto__,c__6473__auto___18515))
})();
var state__6475__auto__ = (function (){var statearr_18514 = f__6474__auto__.call(null);
(statearr_18514[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__6473__auto___18515);
